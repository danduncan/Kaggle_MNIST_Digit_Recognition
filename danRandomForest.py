...
featIndex = 1 # Use sqrt for random forest

n_estimators = 40 # Number of trees in forest
...
# Create model
clf = RandomForestClassifier(criterion=criterion, max_features=maxFeat, n_estimators=n_estimators, n_jobs=n_jobs)
